...
export abstract class IMutation {
  ...
  abstract deleteSegment(
    deleteSegmentInput?: DeleteSegmentInput,
  ): boolean | Promise<boolean>

  abstract insertWaypoint(
    insertWaypointInput?: InsertWaypointInput,
  ): Segment | Promise<Segment>

  abstract updateWaypoint(
    updateWaypointInput?: UpdateWaypointInput,
  ): Segment | Promise<Segment>

  abstract deleteWaypoint(
    deleteWaypointInput?: DeleteWaypointInput,
  ): Segment | Promise<Segment>
}
